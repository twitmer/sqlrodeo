...
public class TestVersion {
	...
	assertNotEquals(new Version("1.2").hashCode(),
		new Version("1.3").hashCode());

	assertEquals(new Version("1.2").hashCode(),
		new Version("1.2").hashCode());
    }
	...
	// Test the constructor that accepts a variable number of Integers with
	// invalid values.
	try {
	...
	String[] invalidStringCtorValues = new String[] { null, "", "b",
		"1.0b", "1.0.0-SNAPSHOT" };
	for (String value : invalidStringCtorValues) {
	    try {
		Version v = new Version(value);
		fail("String-based constructor should not accept this value: "
			+ value);
	    } catch (IllegalArgumentException | NullPointerException e) {
		// Success!
		System.out
			.println("String-based constructor correctly rejected argument: "
				+ value);
	    }
	}
    }
