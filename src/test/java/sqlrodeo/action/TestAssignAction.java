...
public class TestAssignAction {
    ...
    /**
     * Happy path test method for {@link sqlrodeo.action.AssignAction#execute(sqlrodeo.ExecutionContext)}.
     * 
     * @throws Exception
     */
    @Test
    public void testExecute() throws Exception {
        ...
        Element node = XmlFactory.build("<assign id=\"someObject\" value=\"100\"/>").getDocumentElement();
    ...
    public void testExecute_withJexlEvaluationException() throws Exception {
        ...
        // Given: An XML node for the action
        Element node = XmlFactory.build("<assign id=\"someObject\" value=\"cannot be evaluated!\"/>").getDocumentElement();
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Failed to evaluate: cannot be evaluated!"));
