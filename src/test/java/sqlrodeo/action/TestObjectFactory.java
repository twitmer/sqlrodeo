...
public class TestObjectFactory {
	...
	/**
	 * Test method for
	 * {@link sqlrodeo.action.ObjectFactoryAction#execute(sqlrodeo.ExecutionContext)}
	...
	public void testExecute_objectFactory() throws Exception {
		...
		// Given: an XML node for the ObjectFactoryAction WITHOUT a JNDI name.
		Element node = XmlFactory
				.build("<objectFactory id=\"myDataSource\" factoryClassName=\"sqlrodeo.action.TestObjectFactory$MockObjectFactory\" objectClassName=\"String\"></objectFactory>")
				.getDocumentElement();
