...
public class TestConnectionAction {
	 ...
	 * {@link org.sqlrodeo.action.ConnectionAction#execute(org.sqlrodeo.ExecutionContext)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testExecute() throws Exception {
		...
		Element node = XmlFactory
				.build("<connection id=\"me\" datasource-id=\"theDs\" autocommit=\"true\"/>")
				.getDocumentElement();
		...
		EasyMock.expect(mockDataSource.getConnection()).andReturn(
				mockConnection);
	...
	/**
	 * Happy-ish path test method for
	 * {@link org.sqlrodeo.action.ConnectionAction#execute(org.sqlrodeo.ExecutionContext)}
	 * . This version changes the autocommit property of the connection.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Sad path test to test what happens when the action cannot change the
	 ...
	 * {@link org.sqlrodeo.action.ConnectionAction#execute(org.sqlrodeo.ExecutionContext)}
	 * . This version fails to find the DataSource in the context.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	public void testExecute_autocommit_not_specified() throws Exception {
		...
		Element node = XmlFactory.build(
				"<connection id=\"me\" datasource-id=\"theDs\" />")
				.getDocumentElement();
